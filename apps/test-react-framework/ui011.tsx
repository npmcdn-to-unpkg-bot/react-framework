...
export class AppRootStore extends flux.Store<{}> {
  ...
  render(): JSX.Element {
    return <div>
      ...
      <CheckBox $store={st => this.checkBox2 = st ? st : this.checkBox2} id='checkbox2' $title='Check Box Test 2' $defaultValue={true}/><br/>
      <CheckBox $store={st => this.checkBox3 = st ? st : this.checkBox3} id='checkbox3' $title='Check Box Test 3' $defaultValue={false}/><br/>
      <hr/>
